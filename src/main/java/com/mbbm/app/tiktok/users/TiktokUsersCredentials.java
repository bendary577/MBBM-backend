...
public class TiktokUsersCredentials {

    //NOTE : A SCHEDULER MUST USE SELENIUM TO FETCH THIS DATA IN A REGULAR FLOW
    public final static String TIKTOK_AUTH_ENDPOINT = "https://www.tiktok.com/auth/authorize/";
